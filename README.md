...
IDENTITY_SERVICE_CLIENT_ID=diddigo-staging-diddifreeid
IDENTITY_SERVICE_CLIENT_SECRET=<secret-created-in-diddifreeid>
DIDDIMAP_BASE_URL=http://abidjanmaps-backend-staging.diddifree.com
DIDDIMAP_SERVICE_CLIENT_ID=diddigo-staging
DIDDIMAP_SERVICE_TOKEN=<diddimap-service-token>
PUSH_ENABLED=true
...
`in_progress`, DiddiGo cree une trace DiddiMap via
