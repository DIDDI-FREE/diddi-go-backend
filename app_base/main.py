...
from app_base.modules.ride.presentation.backoffice_contract_router import router as backoffice_contract_router
...
app.include_router(backoffice_contract_router)
