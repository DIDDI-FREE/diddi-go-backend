...
class DriverProfileModel(Base):
    ...
    license_back_document_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
...
class VehicleModel(Base):
    ...
    insurance_document_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
    technical_inspection_document_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
    transport_authorization_document_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
    vehicle_photo_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
    vehicle_front_photo_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
    vehicle_back_photo_file_id: Mapped[UUID | None] = mapped_column(_PG_UUID, nullable=True)
    ...
    transport_authorization_document_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    vehicle_photo_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    vehicle_front_photo_url: Mapped[str | None] = mapped_column(Text, nullable=True)
    vehicle_back_photo_url: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class RideModel(Base):
    ...
    trace_analysis_status: Mapped[str | None] = mapped_column(String(30), nullable=True)
    trace_analysis_error_code: Mapped[str | None] = mapped_column(String(80), nullable=True)
    trace_recommendation: Mapped[str | None] = mapped_column(String(80), nullable=True)
    trace_quality_label: Mapped[str | None] = mapped_column(String(40), nullable=True)
    trace_quality_score: Mapped[Decimal | None] = mapped_column(Numeric(5, 4), nullable=True)
